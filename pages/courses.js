  ...
  return (
    <Layout>
      <Box width={[1, 2 / 3]} mx="auto" my={3} p={3}>
        ...
        <Text fontSize={[1, 2, 3]}>
          Courses worth 2 credits last 2 semesters. Courses worth 1 credit last
          1 semester.
        </Text>
        <Box my={3}>
        ...
        <Heading mb={1}>AP Courses</Heading>
        {apCourses.map(c => (
          <CourseBlock
            key={c.name}
            name={c.name}
            ...
            notes={c.notes}
            last={c.name == apCourses[apCourses.length - 1].name}
          />
        ))}
        <Heading mt={4} mb={1}>Higher-Level Courses</Heading>
        {higherLevelCourses.map(c => (
          <CourseBlock
            key={c.name}
            name={c.name}
            credits={c.credits}
            ...
            notes={c.notes}
            last={
              c.name == higherLevelCourses[higherLevelCourses.length - 1].name
            }
          />
        ))}
